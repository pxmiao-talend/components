...
public class DatasetServiceImplDepsTestIT {
    ...
    /**
     * Test method for
     * {@link org.talend.components.api.service.internal.DatasetServiceImpl#loadPom(java.io.InputStream, org.talend.components.api.service.internal.MavenBooter)}
     * .
     */
    @Test
    public void testLoadPom() throws ModelBuildingException, URISyntaxException, IOException {
        DatasetServiceImpl datasetServiceImpl = new DatasetServiceImpl(null);
        ...
        try {
            Model pom = datasetServiceImpl.loadPom(this.getClass().getResourceAsStream("pom.xml"), new MavenBooter() {
    ...
    public void testLoadPomWithAuthentification() throws ModelBuildingException, URISyntaxException, IOException {
        ...
        try {
            Model pom = datasetServiceImpl.loadPom(this.getClass().getResourceAsStream("pom_with_authentified_deps.xml"),
                    new MavenBooter() {
    ...
    public void testLoadPomWithProfiles() throws ModelBuildingException {
        DatasetServiceImpl datasetServiceImpl = new DatasetServiceImpl(null);
        Model pom = datasetServiceImpl.loadPom(this.getClass().getResourceAsStream("pom.xml"), new MavenBooter(), //$NON-NLS-1$
    ...
    public void testGetRuntimeDependencies() throws ModelBuildingException, URISyntaxException, IOException,
        ...
        try {
            Set<String> mavenUriDependencies = datasetServiceImpl.computeDependenciesFromPom(stream, "test", "provided");
    ...
    public void testGetTestDependenciesIncludingTransitive() throws ModelBuildingException, URISyntaxException, IOException,
        ...
        InputStream stream = pomUrl.openStream();
        try {
            Set<String> mavenUriDependencies = datasetServiceImpl.computeDependenciesFromPom(stream, "provided");
    ...
    public void testGetTestDependenciesCache() throws ModelBuildingException, URISyntaxException, IOException,
        ...
        try {
            mavenUriDependencies = datasetServiceImpl.computeDependenciesFromPom(stream, "provided");
            assertThat(mavenUriDependencies, Matchers.containsInAnyOrder(FULL_DEPS_TEST.split(","))); //$NON-NLS-1$
        } finally {
            stream.close();
        }
        ...
        try {
            Set<String> mavenUriDependencies2 = datasetServiceImpl.computeDependenciesFromPom(stream, "provided");
