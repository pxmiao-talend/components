...
public class DatastoreServiceImplDepsTestIT {
    ...
    /**
     * Test method for
     * {@link org.talend.components.api.service.internal.DatastoreServiceImpl#loadPom(java.io.InputStream, org.talend.components.api.service.internal.MavenBooter)}
     * .
     */
    @Test
    public void testLoadPom() throws ModelBuildingException, URISyntaxException, IOException {
        DatastoreServiceImpl datastoreServiceImpl = new DatastoreServiceImpl(null);
        ...
        try {
            Model pom = datastoreServiceImpl.loadPom(this.getClass().getResourceAsStream("pom.xml"), new MavenBooter() {
    ...
    public void testLoadPomWithAuthentification() throws ModelBuildingException, URISyntaxException, IOException {
        ...
        try {
            Model pom = datastoreServiceImpl.loadPom(this.getClass().getResourceAsStream("pom_with_authentified_deps.xml"),
                    new MavenBooter() {
    ...
    public void testLoadPomWithProfiles() throws ModelBuildingException {
        DatastoreServiceImpl datastoreServiceImpl = new DatastoreServiceImpl(null);
        Model pom = datastoreServiceImpl.loadPom(this.getClass().getResourceAsStream("pom.xml"), new MavenBooter(), //$NON-NLS-1$
    ...
    public void testGetRuntimeDependencies() throws ModelBuildingException, URISyntaxException, IOException,
        ...
        try {
            Set<String> mavenUriDependencies = datastoreServiceImpl.computeDependenciesFromPom(stream, "test", "provided");
    ...
    public void testGetTestDependenciesIncludingTransitive() throws ModelBuildingException, URISyntaxException, IOException,
        ...
        InputStream stream = pomUrl.openStream();
        try {
            Set<String> mavenUriDependencies = datastoreServiceImpl.computeDependenciesFromPom(stream, "provided");
    ...
    public void testGetTestDependenciesCache() throws ModelBuildingException, URISyntaxException, IOException,
        ...
        try {
            mavenUriDependencies = datastoreServiceImpl.computeDependenciesFromPom(stream, "provided");
            assertThat(mavenUriDependencies, Matchers.containsInAnyOrder(FULL_DEPS_TEST.split(","))); //$NON-NLS-1$
        } finally {
            stream.close();
        }
        ...
        try {
            Set<String> mavenUriDependencies2 = datastoreServiceImpl.computeDependenciesFromPom(stream, "provided");
