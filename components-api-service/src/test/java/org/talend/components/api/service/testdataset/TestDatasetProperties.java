...
public class TestDatasetProperties extends ComponentPropertiesImpl implements ComponentReferencePropertiesEnclosing {
    ...
    public ComponentReferenceProperties referencedDataset = new ComponentReferenceProperties("referencedDataset", this);

    public static final String TESTCOMPONENT = "TestDataset";

    public TestDatasetProperties(String name) {
        super(name);
    }
    ...
    public void setupLayout() {
        ...
        Widget compListWidget = widget(referencedDataset).setWidgetType(Widget.COMPONENT_REFERENCE_WIDGET_TYPE);
        referencedDataset.componentType.setValue("refComp");
