 ...
 */
public enum DatasetsApiErrorCode implements ErrorCode {

    WRONG_DATASET_NAME(HttpServletResponse.SC_BAD_REQUEST, "name"), //$NON-NLS-1$
     ...
     */
    DatasetsApiErrorCode(int httpStatus) {
     ...
     * @param httpStatus the http status to use.
     */
    DatasetsApiErrorCode(int httpStatus, String... contextEntries) {
