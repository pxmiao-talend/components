 ...
 */
public enum DatastoresApiErrorCode implements ErrorCode {

    WRONG_DATASTORE_NAME(HttpServletResponse.SC_BAD_REQUEST, "name"), //$NON-NLS-1$
    COMPUTE_DEPENDENCIES_FAILED(HttpServletResponse.SC_NOT_FOUND, "path"), //$NON-NLS-1$
     ...
     */
    DatastoresApiErrorCode(int httpStatus) {
     ...
     * @param httpStatus the http status to use.
     */
    DatastoresApiErrorCode(int httpStatus, String... contextEntries) {
