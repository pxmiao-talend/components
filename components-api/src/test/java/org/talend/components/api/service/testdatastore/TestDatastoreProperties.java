...
public class TestDatastoreProperties extends ComponentPropertiesImpl implements ComponentReferencePropertiesEnclosing {
    ...
    public ComponentReferenceProperties referencedDatastore = new ComponentReferenceProperties("referencedDatastore", this);

    public static final String TESTCOMPONENT = "TestDatastore";

    public TestDatastoreProperties(String name) {
        super(name);
    }
    ...
    public void setupLayout() {
        ...
        Widget compListWidget = widget(referencedDatastore).setWidgetType(Widget.COMPONENT_REFERENCE_WIDGET_TYPE);
        referencedDatastore.componentType.setValue("refComp");
