...
/**
 * The FileInputSource provides the mechanism to supply data to other
...
public class FileInputSource implements BoundedSource {
    ...
    private FileInputProperties properties;
    ...
    public BoundedReader createReader(RuntimeContainer container) {
        return new FileInputReader(container, this, this.properties.filename.getStringValue());
    }
