...
public class ThreadIsolatedSystemProperties extends Properties {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ThreadIsolatedSystemProperties.class);
        ...
        synchronized (threadProperties) {
            if (threadDefault == this) {
                ...
                throw new IllegalArgumentException(
                        "Cannot accept instance " + threadDefault.getClass().getName() + " as parameter."); //$NON-NLS-1$ //$NON-NLS-2$
            }
